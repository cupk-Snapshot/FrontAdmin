...
const state = reactive<TableDemoState>({
  tableData: {
    ...
    // 表头内容（必传，注意格式）
    header: [
      { key: 'order_id', colWidth: '', title: '订单号', type: 'text', isCheck: true },
      { key: 'title', colWidth: '', title: '商品描述', type: 'text', isCheck: true },
      { key: 'pic_url', colWidth: '', width: '70', height: '40', title: '商品图片', type: 'image', isCheck: true },
      { key: 'point', colWidth: '', title: '商品积分', type: 'text', isCheck: true },
      { key: 'username', colWidth: '', title: '兑换用户', type: 'text', isCheck: true },
      { key: 'name', colWidth: '', title: '收货人', type: 'text', isCheck: true },
      { key: 'phone_num', colWidth: '', title: '收货号码', type: 'text', isCheck: true },
      { key: 'area', colWidth: '', title: '收货区域', type: 'text', isCheck: true },
      { key: 'address', colWidth: '', title: '收货地址', type: 'text', isCheck: true },
      { key: 'creat_time', colWidth: '', title: '下单时间', type: 'text', isCheck: true }
    ],
    // 配置项（必传）
    config: {
      total: 0, // 列表总数
